...
// Applying the principal of separation of configuration from use.
// i.e.:
...
// Were taking the logic required to wire up all the different actors in our application togeter
...
// ask gameLogic for a new game, update storage, if possible, and
